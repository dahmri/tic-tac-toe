...
export default {
  ...
  'Invite link copied: send it to a friend.': "Lien d'invitation copié : envoie-le à un ami.",
  ...
  'Play tic-tac-toe with me!': 'Joue au morpion avec moi !',
  Played: 'Jouées',
  Player: 'Joueur',
  ...
  'The classic pencil-and-paper game, three ways: against the computer, with a friend on the same screen, or with players around the world.':
    "Le jeu classique du papier et du crayon, de trois façons : contre l'ordinateur, avec un ami sur le même écran, ou avec des joueurs du monde entier.",
  'The game': 'Le jeu',
  ...
  'Your invite link: {url}': "Ton lien d'invitation : {url}",
  ...
  '{mark} played board {b}, square {c}.': '{mark} a joué grille {b}, case {c}.',
  '{mark} played row {row}, column {col}.': '{mark} a joué ligne {row}, colonne {col}.',
  ...
  '{name} invited you to play. Welcome!': "{name} t'invite à jouer. Bienvenue !",
  ...
  '{name} is in your friends now: invite them from the lobby.':
    '{name} fait maintenant partie de tes amis : invite-le depuis le salon.',
  ...
  '✏️ Classic, 3 marks and Ultimate rules': '✏️ Règles classiques, 3 marques et Ultimate',
  '🌍 Whole world': '🌍 Monde entier',
  '🏆 Ratings, seasons and a weekend arena': '🏆 Cotes, saisons et une arène le week-end',
  ...
  '🔗 Share an invite link': "🔗 Partager un lien d'invitation",
  '🔥 Streak: {n} · Best: {best} · Solved: {total}':
    '🔥 Série : {n} · Record : {best} · Résolus : {total}',
  '🧩 A new puzzle every day': '🧩 Un nouveau défi chaque jour',
  '🧩 Puzzle': '🧩 Défi',
};
